...
const progressLabel = document.querySelector('.para1')
const progressBar = document.querySelector('.progress_bar')
const progressValue = document.querySelector('.progress_barcolor')

const allQuotes = [
  'Raise the bar by completing your goals!',
  'Well begun is half done!',
  'Just a step away, keep going!',
  'Wow! You just completed all the goals, time for chill :❤️',
]
